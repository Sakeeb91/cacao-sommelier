...
const steps: ProcessStep[] = [
  {
    ...
    prompt: STATIC_PROMPTS.PROCESS_HARVEST_THUMB.prompt,
    detailPrompt: STATIC_PROMPTS.PROCESS_HARVEST_DETAIL.prompt,
    staticSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_HARVEST_THUMB.filename}`,
    staticDetailSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_HARVEST_DETAIL.filename}`
  },
  {
    id: 2,
    title: "Ferment",
    ...
    prompt: STATIC_PROMPTS.PROCESS_FERMENT_THUMB.prompt,
    detailPrompt: STATIC_PROMPTS.PROCESS_FERMENT_DETAIL.prompt,
    staticSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_FERMENT_THUMB.filename}`,
    staticDetailSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_FERMENT_DETAIL.filename}`
  },
  {
    id: 3,
    title: "Roast",
    ...
    prompt: STATIC_PROMPTS.PROCESS_ROAST_THUMB.prompt,
    detailPrompt: STATIC_PROMPTS.PROCESS_ROAST_DETAIL.prompt,
    staticSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_ROAST_THUMB.filename}`,
    staticDetailSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_ROAST_DETAIL.filename}`
  },
  {
    id: 4,
    title: "Conch",
    ...
    prompt: STATIC_PROMPTS.PROCESS_CONCH_THUMB.prompt,
    detailPrompt: STATIC_PROMPTS.PROCESS_CONCH_DETAIL.prompt,
    staticSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_CONCH_THUMB.filename}`,
    staticDetailSrc: `/images/generated/${STATIC_PROMPTS.PROCESS_CONCH_DETAIL.filename}`
  },
];
          ...
          <div className="relative bg-white w-full max-w-5xl max-h-[90vh] rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row animate-fade-in-up">
            ...
            <div className="lg:w-1/2 relative h-64 lg:h-auto">
              <GenAIImage
                ...
                staticSrc={selectedStep.staticDetailSrc}
