  ...
  const regions: RegionData[] = [
    {
      ...
      peoplePrompt: "Portrait of an elderly Ecuadorian cacao farmer smiling in a lush green cacao grove, wearing a straw hat, soft natural lighting, photorealistic, dignified",
      ...
      cacaoPrompt: "Close up macro shot of a halved raw cacao bean showing intricate purple interior texture, rustic wooden background, natural light"
    },
    {
      ...
      peoplePrompt: "Documentary style shot of workers in Madagascar turning cacao beans in wooden fermentation boxes, golden hour sunlight, dynamic motion blur, rich colors",
      ...
      cacaoPrompt: "Artistic shot of roasted cacao nibs and fresh raspberries on a dark slate surface, dramatic lighting, high contrast"
    },
    {
      ...
      peoplePrompt: "Portrait of a Venezuelan woman drying cacao beans in a village square, colonial church in background, colorful clothing, warm sunlight, cultural photography",
      ...
      cacaoPrompt: "Cinematic shot of dark liquid chocolate being poured, rich texture, steam rising, dark moody lighting, luxury food photography"
    }
  ];
