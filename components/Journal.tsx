...
type ContentBlock = 
  ...
  | { type: 'image'; prompt: string; alt: string; caption?: string };
...
const journalEntries: JournalEntry[] = [
  {
    ...
    coverPrompt: "Cinematic shot of colorful cacao pods hanging on a tree in a tropical rainforest, depth of field, sunlight filtering through leaves, photorealistic nature photography",
    content: [
      { 
        type: 'text', 
      ...
      { 
        type: 'image', 
        prompt: "Close up macro photography of raw cacao beans cut open to show texture, rustic wooden table, soft natural light, high detail", 
  ...
  },
  {
    ...
    coverPrompt: "Close up action shot of molten chocolate being tempered on a marble table, glossy shine, professional chocolatier kitchen, high contrast, steam, delicious",
    content: [
      { 
        type: 'text', 
      ...
      { 
        type: 'image', 
        prompt: "Microscopic artistic rendering of crystal lattice structures, geometric patterns, blue and gold color palette, scientific visualization, 3d render", 
      ...
      { 
        type: 'image', 
        prompt: "Artistic photography of a finished dark chocolate bar with a perfect glossy reflection, sharp edges, dark mood lighting, luxury product shot", 
